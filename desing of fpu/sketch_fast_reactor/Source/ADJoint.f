...
! Setting computed adjoint
      ...
      call ADJ_Normalize_Flux(NG, N_TOT,  al, Flux(1,1), 
     &            Flux_A(1,1), Volume (1) )
...
!         END IF
      ...
      subroutine ADJ_Normalize_Flux(NG, N_TOT, al, Flux, 
     &             Flux_a, Volume)
      implicit none 
*=====================================================================*
...
c     write(*,*) 'Flux_a(1,1), Flux_a(1,2) =', Flux_a(1,1),Flux_a(1,2)


      adjoint_norm = 0. 
      do k = 1, N_TOT
         do n = 1, NG
            adjoint_norm = adjoint_norm + al(n)*Flux(n,k)*Flux_a(n,k)*
     &              Volume(k)
         end do
      end do
