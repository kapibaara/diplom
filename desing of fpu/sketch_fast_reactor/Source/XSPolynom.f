...
c      write(*,*) 'NO SQRT OF DOPPLER TEMPERASTURE FOR WIGL PROBLEM'
...
* Doppler
!          write(*,*)  'k,n1,N_FEEDBACK, nl =', k,n1,N_FEEDBACK, nl
...
ccc          delta_fb(N_FEEDBACK) = (fdback(k,n1,N_FEEDBACK)) - 
ccc     &                   (fdback00(N_FEEDBACK,nl))
...
c          if(k.eq.6.and.n1.eq.10.and.n.eq.2) then
c             write(*,*) 'i=', i, 'sa,=', sa2,
c     &                'sa_fb(i,n,nl)*delta_fb(i)=',
c     &                   sa_fb(i,n,nl)*delta_fb(i)
c          end if
c          write(*,*) 'n = ', n , 'sa_sik =', sa_sik
          end do ! FEEDBACKS
...
!     &      sik2(NG), str2, d2
      real vol
      integer np,ns,nl, i,k,n1,n, kt, nn, nd, i_xs_x, i_xs_y
...
*Local Variables
     ...
     &   n1_rod, n1_nrod, ib, i_xs_x, i_xs_y, n
